...
const Main = (props) => {
  ...
  console.log(props.callActivity)
  ...
  // console.log(userRols) Have to debug this one making lot of re-renders
  ...
  useEffect(() => {
    console.log(props.agentInteraction)
  ...
  const initializeUserAgent = async () => {
    ...
    const uri = UserAgent.makeURI(`sip:${pbxNumber}@${domain}:${port}`);
    ...
    const userAgentOptions = {
      authorizationPassword: pbxNumber,
      authorizationUsername: pbxNumber,
    ...
    try {
      ...
      console.log(registerer,"thissssssssssssssssssssss")
      console.log(AsterikConnectivityLogin)
      console.log(accessToken)
      const AsterikConnectivity = await axios.post(
...
console.log("registerrr",registerer)
  ...
  useEffect(() => {
    ...
    console.log(userAgentRef.current)
  ...
  console.log(isWebRTCConnected)
  if (userRole === '[Agent]' || userRole === undefined) {
    return (
      <>
