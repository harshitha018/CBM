...
import { Card, Grid, Stack, TextField, Tooltip } from "@mui/material";
...
const NavBar = (props) => {
  ...
  const renderMenu = (
    ...
    >
      <MenuItem onClick={handleMenuClose}>Agent Name</MenuItem>
      <MenuItem onClick={handleMenuClose}>Ext Number</MenuItem>
    </Menu>
  );
      ...
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="static">
          ...
          >
            ...
            <div className="card navbarCard" style={{ height: "40px" }}>
            ...
            <Box
              className="card mx-2"
              sx={{ maxWidth: "20rem", height: "40px", borderRadius: "30px" }}
            >
              <Stack direction="row" alignItems="center">
                <Box>
                  <img
                    src={photo}
                    alt=""
                    style={{ width: "40px", height: "35px", marginTop: "0px" }}
                  />
                </Box>
                <Box className="ms-3">
